...
4. Po zakończeniu pracy workerów, zawsze proś o zgodę na weryfikację logów w `.agent-logs/` oraz sprawdzaj jakość kodu w nowo dodanych commitach oznaczonych tagiem `[AI-Grid]`.
